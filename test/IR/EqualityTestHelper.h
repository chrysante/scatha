...
struct StructureEqTester {
    explicit StructureEqTester(std::string name):
        name(std::move(name)) {}
...
struct InstructionEqTester {
    explicit InstructionEqTester(std::string name):
        name(std::move(name)) {}
...
struct BasicBlockEqTester {
    explicit BasicBlockEqTester(std::string name):
        name(std::move(name)) {}
...
struct FunctionEqTester {
    explicit FunctionEqTester(std::string name):
        name(std::move(name)) {}
