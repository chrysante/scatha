...
/**
 ...
 <if-statement>                  ::= "if" <comma-expression> <compound-statement> [<if-statement> | ("else" <compound-statement>)]
...
[[nodiscard]] SCATHA(API) ast::UniquePtr<ast::AbstractSyntaxTree> parse2(utl::vector<Token> tokens, issue::ParsingIssueHandler& issueHandler);
