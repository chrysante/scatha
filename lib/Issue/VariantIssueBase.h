#ifndef ISSUE_VARIANTISSUEBASE_H_
#define ISSUE_VARIANTISSUEBASE_H_
...
protected:
    std::variant<Issues...>& asVariant() {
        return *this;
    }
    std::variant<Issues...> const& asVariant() const {
        return *this;
    }
};
...
#endif // ISSUE_VARIANTISSUEBASE_H_
