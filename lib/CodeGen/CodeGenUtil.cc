...
assembly::Instruction mapOperation(ic::Operation op) {
    ...
    case ic::Operation::XOr: return Instruction::XOr; SC_NO_DEFAULT_CASE();
    }
}
...
assembly::Instruction mapComparison(ic::Operation op) {
    ...
    case ic::Operation::fgeq: return Instruction::fcmp; SC_NO_DEFAULT_CASE();
    }
}
...
assembly::Instruction mapComparisonStore(ic::Operation op) {
    ...
    case ic::Operation::fgeq: return Instruction::setge; SC_NO_DEFAULT_CASE();
    }
}
...
assembly::Instruction mapConditionalJump(ic::Operation op) {
    ...
    case ic::Operation::ifPlaceholder: return Instruction::je; SC_NO_DEFAULT_CASE();
    }
}
