...
void internal::ScopePrinter::printScope(Scope const& scope,
    ...
    //            continue;
    //        }
    //        auto* overloadSet = cast<OverloadSet const*>(entity);
    ...
    //            str << ": "
    //                << (var.type() ? makeQualName(*var.type()) :
    //                "<invalid-type>");
    //        }
    //        str << endl;
