...
namespace scatha::sema {
	...
	public:
		...
		/// TypeID of the analyzed expression if it refers to a type. Otherwise the type of the value that expression yields.
	...
	public:
		...
		static constexpr ExpressionAnalysisResult fail() {
			return { false };
		}
	...
	private:
		...
		{}
		constexpr ExpressionAnalysisResult(bool success):
			_success(success)
		{}
	};
	...
	/**
	 ...
	 - parameter expression: The expression to be analyzed.
	 - parameter symbolTable: The symbol table to be read from and written to.
	 - parameter issueHandler: The issue handler to submit issues to. May be null.
