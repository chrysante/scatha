...
std::ostream &operator<<(std::ostream &str, Label l) { return str << "LABEL: " << l.index << std::endl; }

std::ostream &operator<<(std::ostream &str, RegisterIndex r) { return str << "R[" << +r.index << "]"; }
...
std::ostream &operator<<(std::ostream &str, Value8 v) { return str << +v.value; }

std::ostream &operator<<(std::ostream &str, Value16 v) { return str << v.value; }

std::ostream &operator<<(std::ostream &str, Value32 v) { return str << v.value; }
