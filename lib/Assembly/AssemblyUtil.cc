...
vm::OpCode mapUnaryInstruction(Instruction i) {
    switch (i) {
    case Instruction::allocReg:
        return vm::OpCode::allocReg;
    case Instruction::setBrk:
        return vm::OpCode::setBrk;
    case Instruction::call:
        return vm::OpCode::call;
    case Instruction::ret:
        return vm::OpCode::ret;
    case Instruction::terminate:
        return vm::OpCode::terminate;
    ...
    case Instruction::jne:
        return vm::OpCode::jne;
    case Instruction::jl:
        return vm::OpCode::jl;
    case Instruction::jle:
        return vm::OpCode::jle;
    case Instruction::jg:
        return vm::OpCode::jg;
    case Instruction::jge:
        return vm::OpCode::jge;

    case Instruction::itest:
        return vm::OpCode::itest;
    case Instruction::utest:
        return vm::OpCode::utest;

    case Instruction::sete:
        return vm::OpCode::sete;
    case Instruction::setne:
        return vm::OpCode::setne;
    case Instruction::setl:
        return vm::OpCode::setl;
    case Instruction::setle:
        return vm::OpCode::setle;
    case Instruction::setg:
        return vm::OpCode::setg;
    case Instruction::setge:
        return vm::OpCode::setge;
...
vm::OpCode mapBinaryInstruction(Instruction i, Element const &arg1, Element const &arg2) {
    ...
    case Instruction::sl: {
        constexpr OpCodeTable table = {Instruction::sl,
    ...
    case Instruction::sr: {
        constexpr OpCodeTable table = {Instruction::sr,
    ...
    case Instruction::And: {
        constexpr OpCodeTable table = {Instruction::And,
    ...
    case Instruction::Or: {
        constexpr OpCodeTable table = {Instruction::Or,
    ...
    case Instruction::XOr: {
        constexpr OpCodeTable table = {Instruction::XOr,
...
void print(AssemblyStream const &a) { print(a, std::cout); }
...
void print(AssemblyStream const &a, sema::SymbolTable const &sym) { print(a, sym, std::cout); }
