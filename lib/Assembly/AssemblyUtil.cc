...
struct Printer {
    ...
    void printInstruction(Instruction i) {
        ...
        case ret: str << ret; return;

        case terminate: str << terminate; return;
        ...
        case bnt: printUnaryInstruction(i); return;
        ...
        case And:
        case Or:
        case XOr: printBinaryInstruction(i); return;
