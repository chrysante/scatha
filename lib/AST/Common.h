...
template <typename T> inline constexpr NodeType ToEnumNodeType = internal::ToEnumNodeTypeImpl<T>::value;
template <NodeType E> using ToNodeType                         = typename internal::ToNodeTypeImpl<E>::type;
