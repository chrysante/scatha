...
void printSource(AbstractSyntaxTree const *root) { printSource(root, std::cout); }
    ...
    void          print(AbstractSyntaxTree const &node) {
                 visit(node, utl::visitor{
                        ...
                        [&](ExpressionStatement const &es) {
                            SC_ASSERT(es.expression != nullptr, "Expression statement without an expression is "
                                                                                  "invalid");
                            print(*es.expression);
                            str << ";";
                        },
                        ...
                        [&](Identifier const &i) { str << i.value(); },
                        [&](IntegerLiteral const &l) { str << l.value; },
                        [&](BooleanLiteral const &l) { str << l.value; },
                        [&](FloatingPointLiteral const &l) { str << l.value; },
