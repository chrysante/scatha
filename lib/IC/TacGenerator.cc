...
void Context::generate(ast::ExpressionStatement const &statement) { dispatchExpression(*statement.expression); }
...
TasArgument Context::generateExpression(ast::Identifier const &id) { return Variable(id.symbolID); }
...
TasArgument           Context::generateExpression(ast::IntegerLiteral const &lit) { return LiteralValue{lit}; }

TasArgument           Context::generateExpression(ast::BooleanLiteral const &lit) { return LiteralValue{lit}; }

TasArgument           Context::generateExpression(ast::FloatingPointLiteral const &lit) { return LiteralValue{lit}; }

static sema::SymbolID getSymbolID(ast::Expression const &expr) {
    return ast::visit(expr, utl::visitor{[](ast::Identifier const &id) { return id.symbolID; },
...
void      Context::submitFunctionEndLabel() { code.push_back(FunctionEndLabel{}); }
...
TasArgument Context::makeTemporary(sema::TypeID type) { return Temporary{tmpIndex++, type}; }
