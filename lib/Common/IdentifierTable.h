...
namespace scatha {
	...
	public:
		 ...
		 */
		std::pair<NameID, bool> addName(std::string const& name, NameCategory category);
		 ...
		 */
		NameID declareType(std::string const& name);
		 ...
		 */
		TypeEx& defineType(std::string const& name);
		 ...
		 */
		std::pair<Function*, bool> declareFunction(std::string const& name);
		 ...
		 */
		std::pair<Variable*, bool> declareVariable(std::string const& name, TypeID typeID, bool isConstant);
		 ...
		 */
		NameID lookupName(std::string const& name, NameCategory category = NameCategory::None) const;
		
		TypeEx& findTypeByName(std::string const& name) {
			return utl::as_mutable(utl::as_const(*this).findTypeByName(name));
		}
		
		TypeEx const& findTypeByName(std::string const& name) const;
