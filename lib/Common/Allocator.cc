...
namespace scatha {
	...
	SCATHA(DISABLE_UBSAN) /// Disable UBSan for method \p allocate  as it may perform pointer arithmetic on \p nullptr. This pointer will be never dereferenced though, so its all fine.
